# -*- coding: utf-8 -*-
"""
V101 Data Status + Quality Check Version

V100.1 기반 개선:
- stock_candidates.json 생성 유지
- v101_generation_summary.json 생성
- app_data_status.json 추가 생성
- 앱/사용자가 데이터 기준일, 생성시간, 후보 수, 유니버스 소스, 업종 분포를 확인 가능
- 데이터 품질 경고 qualityWarnings 추가

주의:
- GitHub Actions에서 KRX 전체 유니버스 조회가 실패하면 fallback 유니버스로 전환
- 수급 조회는 비활성화
"""
...
SUMMARY_JSON = "v101_generation_summary.json"
ERROR_LOG = "v101_collection_errors.txt"
APP_STATUS_JSON = "app_data_status.json"

LOOKBACK_DAYS = 180
SLEEP_SECONDS = 0.10

UNIVERSE_TOP_N_BY_TRADING_VALUE = 2500
FINAL_TOP_N = 50
...
FALLBACK_UNIVERSE = [
    ...
    ("028260", "삼성물산", "KOSPI"), ("051910", "LG화학", "KOSPI"),
    ("006400", "삼성SDI", "KOSPI"), ("035720", "카카오", "KOSPI"),
    ("032830", "삼성생명", "KOSPI"), ("086790", "하나금융지주", "KOSPI"),
    ("015760", "한국전력", "KOSPI"), ("009540", "HD한국조선해양", "KOSPI"),
    ("329180", "HD현대중공업", "KOSPI"), ("042660", "한화오션", "KOSPI"),
    ("010140", "삼성중공업", "KOSPI"), ("012450", "한화에어로스페이스", "KOSPI"),
    ("272210", "한화시스템", "KOSPI"), ("047810", "한국항공우주", "KOSPI"),
    ("079550", "LIG넥스원", "KOSPI"), ("064350", "현대로템", "KOSPI"),
    ("034020", "두산에너빌리티", "KOSPI"), ("267260", "HD현대일렉트릭", "KOSPI"),
    ("010120", "LS ELECTRIC", "KOSPI"), ("010130", "고려아연", "KOSPI"),
    ("003670", "포스코퓨처엠", "KOSPI"), ("066970", "엘앤에프", "KOSPI"),
    ("361610", "SK아이이테크놀로지", "KOSPI"), ("006260", "LS", "KOSPI"),
    ("096770", "SK이노베이션", "KOSPI"), ("352820", "하이브", "KOSPI"),
    ("259960", "크래프톤", "KOSPI"), ("251270", "넷마블", "KOSPI"),
    ("030200", "KT", "KOSPI"), ("017670", "SK텔레콤", "KOSPI"),
    ("036570", "엔씨소프트", "KOSPI"), ("090430", "아모레퍼시픽", "KOSPI"),
    ("051900", "LG생활건강", "KOSPI"), ("192820", "코스맥스", "KOSPI"),
    ("097950", "CJ제일제당", "KOSPI"), ("004170", "신세계", "KOSPI"),
    ("023530", "롯데쇼핑", "KOSPI"), ("011200", "HMM", "KOSPI"),
    ("003490", "대한항공", "KOSPI"), ("047050", "포스코인터내셔널", "KOSPI"),
    ("042700", "한미반도체", "KOSPI"), ("009150", "삼성전기", "KOSPI"),
    ("011070", "LG이노텍", "KOSPI"), ("011790", "SKC", "KOSPI"),
    ("010620", "현대미포조선", "KOSPI"), ("010060", "OCI홀딩스", "KOSPI"),
    ("241560", "두산밥캣", "KOSPI"), ("042670", "HD현대인프라코어", "KOSPI"),
    ("000720", "현대건설", "KOSPI"), ("047040", "대우건설", "KOSPI"),
    ("028050", "삼성엔지니어링", "KOSPI"), ("128940", "한미약품", "KOSPI"),
    ("326030", "SK바이오팜", "KOSPI"), ("247540", "에코프로비엠", "KOSDAQ"),
    ("086520", "에코프로", "KOSDAQ"), ("196170", "알테오젠", "KOSDAQ"),
    ("277810", "레인보우로보틱스", "KOSDAQ"), ("039030", "이오테크닉스", "KOSDAQ"),
    ("140860", "파크시스템스", "KOSDAQ"), ("240810", "원익IPS", "KOSDAQ"),
    ("058470", "리노공업", "KOSDAQ"), ("095340", "ISC", "KOSDAQ"),
    ("222800", "심텍", "KOSDAQ"), ("067310", "하나마이크론", "KOSDAQ"),
    ("036930", "주성엔지니어링", "KOSDAQ"), ("348370", "엔켐", "KOSDAQ"),
    ("112040", "위메이드", "KOSDAQ"), ("263750", "펄어비스", "KOSDAQ"),
    ("293490", "카카오게임즈", "KOSDAQ"), ("145020", "휴젤", "KOSDAQ"),
    ("086900", "메디톡스", "KOSDAQ"), ("141080", "리가켐바이오", "KOSDAQ"),
    ("028300", "HLB", "KOSDAQ"), ("035900", "JYP Ent.", "KOSDAQ"),
    ("041510", "에스엠", "KOSDAQ"), ("122870", "와이지엔터테인먼트", "KOSDAQ"),
    ("214450", "파마리서치", "KOSDAQ"), ("237690", "에스티팜", "KOSDAQ"),
    ("253450", "스튜디오드래곤", "KOSDAQ"), ("035760", "CJ ENM", "KOSDAQ"),
    ("257720", "실리콘투", "KOSDAQ"), ("018290", "브이티", "KOSDAQ"),
    ("161890", "한국콜마", "KOSPI"), ("000250", "삼천당제약", "KOSDAQ"),
    ("214150", "클래시스", "KOSDAQ"), ("214370", "케어젠", "KOSDAQ"),
    ("108320", "LX세미콘", "KOSPI"), ("089030", "테크윙", "KOSDAQ"),
    ("204320", "HL만도", "KOSPI"), ("018880", "한온시스템", "KOSPI"),
    ("005850", "에스엘", "KOSPI"), ("011210", "현대위아", "KOSPI"),
    ("000150", "두산", "KOSPI"), ("000880", "한화", "KOSPI"),
    ("003550", "LG", "KOSPI"), ("034730", "SK", "KOSPI"),
    ("316140", "우리금융지주", "KOSPI"),
]
...
def build_liquid_universe(base_date: str):
    frames = []
    ...
    try:
        ...
        for col in ["종가", "시가총액", "거래대금"]:
            if col not in universe.columns:
                print(f"[경고] 필수 컬럼 누락: {col}. fallback 전환")
        ...
        print(f"[경고] 유니버스 처리 실패: {e}. fallback 전환")
...
def make_recent_issue(industry, tags, weekly_breakout, daily_breakout, rsi_value, price_change_rate, trading_value, rank, universe_source):
    ...
    parts.append("fallback 유니버스" if universe_source.startswith("fallback") else "KRX 전체 유니버스")
    if tags:
...
def calculate_candidate(row: pd.Series, base_date: str, rank_by_value: int, universe_source: str):
    ...
    technical = 38
    if current_price > ma5 > 0: technical += 4
    if current_price > ma20 > 0: technical += 8
    if current_price > ma60 > 0: technical += 8
    if ma20 > ma60 > 0: technical += 6
    if ma60 > ma120 > 0: technical += 4
    if weekly_breakout: technical += 10
    if daily_breakout: technical += 6
    if macd_value > macd_signal: technical += 6
    if 45 <= rsi_value <= 70: technical += 6
    elif 70 < rsi_value <= 78: technical += 1
    elif rsi_value > 78: technical -= 6
    if price_change_rate > 0: technical += 3
    if price_change_rate > 7: technical -= 5
    technical = int(max(0, min(82, technical)))

    liquidity = 0
    if trading_value >= 100_000_000_000: liquidity += 8
    elif trading_value >= 50_000_000_000: liquidity += 6
    elif trading_value >= 20_000_000_000: liquidity += 4
    elif trading_value >= 10_000_000_000: liquidity += 2
    ...
    if weekly_breakout and daily_breakout: issue += 4
    if macd_value > macd_signal and 45 <= rsi_value <= 70: issue += 3
    if rank_by_value <= 50: issue += 3
    elif rank_by_value <= 100: issue += 2
    elif rank_by_value <= 200: issue += 1
    issue = int(max(0, min(10, issue)))

    score = int(max(0, min(100, technical + liquidity + issue)))

    return {
        "name": name, "code": code, "market": market, "industry": industry,
        "grade": score_to_grade(score), "previousGrade": None, "score": score,
        "technicalScore": technical, "flowScore": 0, "issueScore": issue,
        "flowDataStatus": "disabled", "currentPrice": current_price,
        "priceChangeRate": round(price_change_rate, 2),
        "weeklyCloudBreakout": bool(weekly_breakout), "dailyCloudBreakout": bool(daily_breakout),
        "reportCount": 0, "targetPriceUp": False,
        "foreignNetBuy": False, "pensionNetBuy": False, "institutionNetBuy": False,
        "recentIssue": make_recent_issue(industry, tags, weekly_breakout, daily_breakout, rsi_value, price_change_rate, trading_value, rank_by_value, universe_source),
        "tradingValue": trading_value, "marketCap": market_cap, "rsi": round(rsi_value, 2),
        "universeRankByTradingValue": rank_by_value,
        "selectionSource": f"KRX_UNIVERSE_AUTO_TOP50_V101_{universe_source}",
        "selectionTags": tags, "industryConfidence": confidence,
    }


def build_quality_warnings(summary, candidates, errors):
    warnings = []
    if summary["finalCandidateCount"] < FINAL_TOP_N:
        warnings.append(f"최종 후보 수가 {FINAL_TOP_N}개 미만입니다.")
    if summary["universeSource"].startswith("fallback"):
        warnings.append("KRX 전체 유니버스 조회 실패로 fallback 유니버스를 사용했습니다.")
    if summary["errorCount"] > 20:
        warnings.append("개별 종목 조회 오류가 20건을 초과했습니다.")
    if candidates:
        industries = [x.get("industry", "") for x in candidates]
        top_industry_count = max(industries.count(i) for i in set(industries))
        if top_industry_count >= 25:
            warnings.append("TOP 50의 절반 이상이 하나의 업종에 집중되어 있습니다.")
    return warnings
...
def generate_stock_candidates():
    ...
    candidates = sorted(
        candidates,
        key=lambda x: (x["score"], x["weeklyCloudBreakout"], x["dailyCloudBreakout"], x.get("tradingValue", 0)),
        reverse=True,
    )
    ...
    summary = {
        "version": "V101_DATA_STATUS_QUALITY_CHECK",
        "generatedAt": generated_at.strftime("%Y-%m-%d %H:%M:%S"),
        "generatedAtKSTLike": generated_at.strftime("%Y-%m-%d %H:%M:%S"),
        "baseDate": base_date,
    ...
    quality_warnings = build_quality_warnings(summary, final_candidates, errors)
    summary["qualityWarnings"] = quality_warnings
    summary["status"] = "warning" if quality_warnings else "ok"
    ...
    with open(APP_STATUS_JSON, "w", encoding="utf-8") as f:
        json.dump(app_status, f, ensure_ascii=False, indent=2)

    print("=" * 70)
    print("V101 데이터 품질 진단 자동선별 완료")
    print("상태:", summary["status"])
    print("분석 기준 거래일:", base_date)
    print("유니버스 소스:", universe_source)
